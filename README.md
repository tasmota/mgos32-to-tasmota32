...
2. For devices with Shelly firmware 1.3.x use packages from release [v13.4.1](https://github.com/tasmota/mgos32-to-tasmota32/releases/tag/v13.4.1) to convert!
