...
- Shelly devices with firmware >= v1.5.x are not supported !
...
1. ⚠️ Needed ⚠️ Update the device to Shelly firmware = 1.4.x **not** 1.5.x (Internet access!!)
2. For devices with no 1.4.x Shelly firmware use 1.3.x and packages from release [v13.4.1](https://github.com/tasmota/mgos32-to-tasmota32/releases/tag/v13.4.1) to convert!
